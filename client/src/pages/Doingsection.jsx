...
function Doingsection({user, tasks, setTasks, dragStart, dragEnter, drop}) {
...
const divstyle = {
  ...
  return (
    ...
    <Container key={`${uuidv4()}`} 
        onDragEnter={(e)=>dragEnter(e,'doing')}
    ...
    <TaskContainer>

      {
        ...
        <button onClick={handleaddclick}>+</button>
         <ModalForm isOpen={addmodalIsOpen} onRequestClose={closeAddModal} onSubmit={handleSubmit} SectionName={'doing'} user={user}/>
        <DeleteModalForm isOpen={deletemodalIsOpen} onRequestClose={closeDeleteModal} onSubmit={handleDeleteSubmit} SectionName={'doing'} user={user} />
        {editmodalIsOpen && (
        <EditModalFrom isOpen={editmodalIsOpen} onRequestClose={closeEditModal} onSubmit={handleEditSubmit} SectionName={'doing'} user={user} taskId={SelectedTaskId} />
        )}
    </Container>
